...
awful.keyboard.append_global_keybinding(
	awful.key({ mod }, "x", function() awesome.emit_signal("central_panel::toggle", awful.screen.focused())
	end)
)
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ mod }, "e", function()
		awful.spawn.with_shell(apps.default.discord_emote)
	end, { description = "open discord emote wheel", group = "app" }),
