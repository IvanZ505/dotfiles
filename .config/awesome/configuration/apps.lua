...
return {
	...
	default = {
		...
		--- Default code editor
		code_editor = "jetbrains-toolbox",
		--- Default web browser
		web_browser = "firefox",
		--- Default file manager
		file_manager = "nemo",
		--- Default network manager
		network_manager = "alacritty -e nmcli",
		...
		discord_emote = "/home/izheng/DiscordEmotes/emote.sh -c -r /home/izheng/DiscordEmotes/sample.rofi"
	},
